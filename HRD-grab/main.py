...
parser.add_argument('--data_root_dir', type=str, default= '../HistoFL-master/DATA_ROOT_DIR',
                    help='data directory')
...
parser.add_argument('--results_dir', default='./results/init_weight', help='权重5/4幂次方')
# parser.add_argument('--results_dir', default='./results/small_pow_3_2', help='权重5/4幂次方')
